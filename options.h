...
struct connection {
    ...
    int   group_id;                 /* Index of config group */
...
typedef struct {
    ...
    connection_t *conn;               /* Connection structure */
